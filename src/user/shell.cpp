...
size_t __stdcall shell(const kiv_hal::TRegisters &regs) {
	...
	do {
		...
		// jak uživatel píše na konzoli, čtu po znaku a ukládám do bufferu
		// dokud není plný
		// vzhledem k tomu, že se nic nenuluje, tak tohle přepisuje buffer
		...
		// řetězec v bufferu začíná "echo " -> zkontroluj
		// jestli něco následuje a vypiš to
		if (echo_cmd.compare(0, 5, buffer, 5) == 0 ) {

			// naplň parameters
			// buffer[5:] je řetězec po "echo "
