...
// "C" znamená, že hlavička je C kompatibilní, tj. že kód psaný v C
// může tuhle funkci volat
/*
	V regs.rax.x očekáván handle na std_in.
	V regs.rbx.x očekáván handle na std_out.
*/
